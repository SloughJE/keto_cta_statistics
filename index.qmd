...
To isolate biological effects, you must model follow-up directly with baseline as a covariate, not as part of the outcome. This also avoids spurious associations when predictors are correlated with baseline, even if they aren’t the same variable.
...
2. **ΔNCPV as Outcome**  
   ...
   Mathematical coupling → is regression slope a **mathematical artifact or biology**
