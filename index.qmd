...
<br>
Because they're being used to amplify certainty in a weak design, without transparency about the assumptions that drive the result.
...
#### Prior Scale Sensitivity Analysis
...
ggplotly(prior_sensitivity , height = 400, width = 600) %>%
  config(displayModeBar = FALSE) 
